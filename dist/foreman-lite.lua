-- ============================================================================
-- FICSIT Foreman — LITE EEPROM  v0.10.0   (GENERATED by tools/bundle.py)
...
if #list == 0 then for cid in pairs(conns) do list[#list + 1] = cid end end
local given = 0
...
if i == #list then share = add - given end
