-- ============================================================================
-- FICSIT Foreman — LITE EEPROM  v0.16.6   (GENERATED by tools/bundle.py)
...
if pb then
local pre = self:findPath(src, pb.feeder)
...
path = path or self:findPath(src, dst)
...
Router.balanceMargin = Router.balanceMargin or 24
...
Router._stallGates  = Router._stallGates or {}
...
if stalled then
add = math.min(add, Router.inflightFloor - inflight)
end
if add > 0 then
local list = {}
...
local port = ports and ports[ing.name]
...
if not placedAny then return fail(ing.name) end
else
...
Planner._tempRecipe[pick.opt.ctorId] = nil
end
...
if hint and not assignedIng[hint] then
...
modules.Router._delivPrev = {}
modules.Router._stallGates = {}
