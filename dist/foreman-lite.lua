-- ============================================================================
-- FICSIT Foreman — LITE EEPROM  v0.21.0   (GENERATED by tools/bundle.py)
...
Router._seen = Router._seen or {}
if item then Router._seen[item] = true end
...
if Router._legFullMach then Router._legFullMach[best.to] = nil end
...
Router._seen = Router._seen or {}
if nm then Router._seen[nm] = true end
if sender.getInput then
...
if Router._legFullMach then Router._legFullMach[out.to] = nil end
...
Router._legSent = Router._legSent or {}
Router._arrived = Router._arrived or {}
Router._connCid = Router._connCid or {}
Router._legQueue = Router._legQueue or {}
Router._heldFresh = Router._heldFresh or {}
Router.corkPatience = Router.corkPatience or 100
...
Planner.drainIdle   = Planner.drainIdle or 2
Planner._probe      = Planner._probe or {}
Planner.probeAfter  = Planner.probeAfter or 4
Planner.pourSlice   = Planner.pourSlice or 25
Planner.drainStall  = Planner.drainStall or 8
Planner._flowDry    = Planner._flowDry or {}
Planner._legView    = Planner._legView or {}
Planner._drainEpisode = Planner._drainEpisode or {}
Planner._wanted     = Planner._wanted or {}
Planner._clearQ     = Planner._clearQ or {}
Planner._clearN     = Planner._clearN or {}
Planner._clearDry   = Planner._clearDry or {}
Planner.clearPark   = Planner.clearPark or 3
...
Planner._clearPops = Planner._clearPops or {}
...
table.sort(list, function(a, b)
if a.member ~= b.member then return a.member > b.member end
if a.amt ~= b.amt then return a.amt < b.amt end
return a.nm < b.nm
end)
q = {}
...
local nm = table.remove(q, 1); q[#q + 1] = nm
...
Planner._wanted[cid] = { nm = tostring(opt.recipe.name), opt = opt }
...
Planner._clearDry[cid] = nil; Planner._clearPops[cid] = nil; Planner._clearN[cid] = nil end
...
if self:_clearStep(cid, opt, live) then return true end
end
if cand then
Planner._probe[cid] = nil
local ep2 = Planner._drainEpisode[cid] or {}; Planner._drainEpisode[cid] = ep2
...
modules.Planner._probe = {}
modules.Planner._flowDry = {}
modules.Planner._legView = {}
modules.Planner._drainEpisode = {}
modules.Router._seen = {}
modules.Planner._wanted = {}; modules.Planner._clearQ = {}; modules.Planner._clearN = {}
modules.Planner._clearDry = {}; modules.Planner._clearPops = {}
modules.Router._legQueue = {}
modules.Router._arrived = {}; modules.Router._legTrusted = {}
modules.Router._legSent = {}
modules.Router._heldFresh = {}
end
