-- ============================================================================
-- FICSIT Foreman — LITE EEPROM  v0.17.5   (GENERATED by tools/bundle.py)
...
Planner.probeAfter  = Planner.probeAfter or 10
...
if self:_probeFire(cid, opt) then return true end
end
if cand then
Planner._probe[cid] = nil
pcall(function() opt.ctor:setRecipe(cand.recipe) end)
