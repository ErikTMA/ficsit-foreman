-- ============================================================================
-- FICSIT Foreman — LITE EEPROM  v0.1.0   (GENERATED by tools/bundle.py)
...
-- ============================================================================
local PIN  = "v0.1.0"
local BASE = "https://raw.githubusercontent.com/ErikTMA/ficsit-foreman/" .. PIN .. "/dist/"
...
local function fetchFull()
  ...
  if not full_body:find("--[[FOREMAN_EOF]]", 1, true) then
