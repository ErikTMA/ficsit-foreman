-- ============================================================================
-- FICSIT Foreman — LITE EEPROM  v0.18.2   (GENERATED by tools/bundle.py)
...
else st.n = 0; Planner._probe[cid] = nil; Planner._drainEpisode[cid] = nil end
...
if jammed and self:_probeFire(cid, opt) then return true end
end
if cand then
Planner._probe[cid] = nil
local ep2 = Planner._drainEpisode[cid] or {}; Planner._drainEpisode[cid] = ep2
